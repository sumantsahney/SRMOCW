  ...
  <header id="header" class="full_width clear">
    ...
    <div id="header-contact">
      <ul style="position: absolute;margin-left: 187px;margin-top: 40px" class="list none">
        <li><div style="float: right; color: white">Hi <?php echo $userRow['username']; ?>&nbsp;<a href="logout.php?logout" style="color: white">Sign Out</a></div></li>
      </ul>
      <ul class="list none">
...
<div class="wrapper row2">
  <nav id="topnav">
    <ul class="clear">
      ...
      <li><a class="drop" href="view_all_student.php" title="Pages">Find Course</a>
      </li>
      ...
      <li><a class="drop" href="view_subscribed.php" title="Subscribed">Subscribed courses</a>
      </li>
